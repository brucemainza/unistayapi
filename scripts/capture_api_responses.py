...
Runs the app against an in-memory SQLite database (same setup as the pytest suite)
and records success/error responses for every endpoint. External service behavior
reflects whatever credentials are present in the active .env file.
"""
    ...
    try:
        ...
        async with httpx.AsyncClient(transport=transport, base_url="http://testserver") as client:
            ...
            if new_house_id:
                ...
                # This currently triggers a 500 due to cascade delete issue with rooms
